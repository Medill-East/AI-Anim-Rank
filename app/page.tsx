...
export default function Home() {
  ...
  return <main><AppStatus syncBaseUrl={process.env.VITE_SYNC_BASE_URL ?? ""} /><RankingWorkspace works={snapshot.works} methodologyVersion={snapshot.methodologyVersion} /></main>;
}
